...
import com.course.betitarev.betitarev.activities.ConfirmBetActivity;
...
/**
 * This class handle messages and notifications between {@link com.course.betitarev.betitarev.objects.User}.
 */
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    /**
     * This function send a message to the {@link com.course.betitarev.betitarev.objects.Arbitrator} to get the answer of the bet.
     *
     * @param bet
     * @param betId
     */
    protected static void sendMessageForTheAnswer(Bet bet, String betId) {
        FireBaseQuery.sendMessage(new Notification("Answer for the bet",
                "Phrase: " + bet.getPhrase() + "\n" +
                        "Player 1 guessing: " + bet.getPlayer1().getGuessing() + "\n" +
                        "Player 2 guessing: " + bet.getPlayer2().getGuessing(),
