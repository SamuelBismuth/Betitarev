...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private EditText inputName, inputFamilyName, inputEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String familyName = inputFamilyName.toString();
    ...
    private void addUserChangeListener() {
        ...
        mFirebaseDatabase.child(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, "User data is changed!" + user.getName() + ", " + user.getMail().toString());

                // Display newly updated name and email
                txtDetails.setText(user.getName() + ", " + user.getMail());
